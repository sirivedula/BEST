...
<title>BLC : Feedback Thankyou</title>
...
<table width='500' border='1' cellspacing='0' cellpadding='4' style='font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:normal; color:#000000;'>
  <tr>
    <td colspan='2' align='center' valign='middle'><span style='color:#FF0000;'><strong>Feedback from Website</strong></span></td>
  </tr>
  <tr>
    <td width='50%' align='left' valign='middle'><strong>Name :</strong></td>
    <td width='50%' align='left' valign='middle'>$name</td>
  </tr>
  <tr>
    <td width='50%' align='left' valign='middle'><strong>Number :</strong></td>
    <td width='50%' align='left' valign='middle'>$number</td>
  </tr>
  <tr>
    <td width='50%' align='left' valign='middle'><strong>Comments :</strong></td>
    <td width='50%' align='left' valign='middle'>$comment</td>
  </tr>
  <tr>
...
echo "<h2>Thank you. We have received your details. We will get back to you soon.</h2>";
?>
