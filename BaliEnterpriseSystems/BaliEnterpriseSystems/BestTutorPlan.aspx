<%@ Page Title="BEST - Tutor Plans" Language="C#" MasterPageFile="~/Best.Master" AutoEventWireup="true" CodeBehind="BestTutorPlan.aspx.cs" Inherits="BaliEnterpriseSystems.BestTutorPlan" %>
	    ...
	    <div class="ContentCenDiv">
    	    <div class="ContentbrdrDiv">
			    <div class="LeftNav">
			        ...
			        <div class="CAreaDiv">
            <div class="centered">
                <table id="tblStudentSel"><tr><td style="text-align:center;">Tutor: <select onchange="submit();" id="selTutor" name="selTutor"><asp:Literal ID="ltrTutorOpts" runat="server"></asp:Literal></select></td></tr>
                <tr><td>
