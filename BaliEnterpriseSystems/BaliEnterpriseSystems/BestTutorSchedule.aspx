<%@ Page Title="" Language="C#" MasterPageFile="~/Best.Master" AutoEventWireup="true" CodeBehind="BestTutorSchedule.aspx.cs" Inherits="BaliEnterpriseSystems.BestTutorSchedule" %>
	    ...
	    <div class="ContentCenDiv">
    	    <div class="ContentbrdrDiv">
			    <div class="LeftNav">
			        ...
			        <div class="CAreaDiv">
            <div class="centered">
                <table id="tblStudentSel"><tr><td colspan="3" style="text-align:center;">Tutor: <select onchange="submit();" id="selTutor" name="selTutor"><asp:Literal ID="ltrTutorOpts" runat="server"></asp:Literal></select></td></tr>
		            ...
		            <table style="width:100%;font-family:Tahoma;font-size:11px;" cellspacing="0" cellpadding="0" border="0">
			            <tr>
				            <td id="tdPlanner" style="vertical-align:top;width:100%;">
					            <asp:Literal ID="ltrTutorSchedule" runat="server"></asp:Literal>
				            </td>
			            </tr>
		            </table>            		
	            </div>       
